...
export const CONTRACT_FULL_TIME = `
    ...
    <body>
        ...
        <div class="clause-row">
            <div class="clause-num">2.2</div>
            <div class="clause-text">
                Las partes reconocen y declaran que el cargo de <span class="bold">EL TRABAJADOR</span> está <span class="bold">SUJETO A CONTROL</span> de acuerdo a lo establecido en el artículo 43 del Decreto Supremo Nro. 003-97-TR.
            </div>
        </div>
        ...
        <div class="clause-row">
            <div class="clause-num">3.2</div>
            <div class="clause-text">
                Las partes acuerdan que dado que el cargo que desempeñará <span class="bold">EL TRABAJADOR</span> corresponde a uno <span class="bold">SUJETO A CONTROL.</span>
            </div>
        </div>
        ...
        <div class="clause-row">
            <div class="clause-num">8.6</div>
            <div class="clause-text">
                <span class="bold">EL TRABAJADOR,</span> por su cargo y la naturaleza de su prestación de servicios se encuentra <span class="bold">SUJETO A CONTROL.</span>
            </div>
        </div>
