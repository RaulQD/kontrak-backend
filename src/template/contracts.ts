...
export const generatePartTimeContract = async (
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      doc.image(SIGNATURE_EMPLOYEE, col1X + 25, imageY, {
        width: imageWidth,
        height: imageHeight,
    ...
    //AGREGAR IMAGEN 2
    try {
      doc.image(SIGNATURE_EMPLOYEE_TWO, col2X + 25, imageY, {
        width: imageWidth,
        height: imageHeight,
        fit: [imageWidth, imageHeight],
        align: 'center',
...
export const generateAPEContract = async () => {};
export const generateDataTreatmentPDF = async (data: EmployeeData) => {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({ size: 'A4' });
    doc.page.margins.top = 30.12; // 2.05 cm
    doc.page.margins.bottom = 33.89; // 0.49 cm
    ...
    doc
      ...
      .font('Arial Normal')
      .text(`identificado con DNI N° ${data.dni} (en adelante `, {
        continued: true,
        align: 'justify',
      })
      .font('Arial Bold')
